...
data class AdDTO(val id: Long, val uuid: String, val createdBy: String, val updatedBy: String,
                 ...
                 val medium: String, val reference: String, val expires: LocalDateTime, val updated: LocalDateTime,
                 val publishedByAdmin: LocalDateTime?, val employer: AdCompany?, val categoryList: List<Category> = listOf(), val businessName: String?)
